    ...
    <div className="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen flex flex-col justify-between">
      ...
      <header className="bg-slate-900 text-white shadow-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          {/* Navigasi Utama */}
          <nav
            aria-label="Navigasi Utama Landing Page"
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              to="/register"
              className="text-xs font-semibold bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition shadow-sm"
            >
              Daftar Sekarang
            </Link>
          </div>
      ...
      {/* Section Hero Utama */}
      <main className="max-w-7xl mx-auto px-4 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-sm md:text-base text-slate-600 leading-relaxed">
            Solusi AI terintegrasi untuk mahasiswa D3 Teknik Informatika SV UNS.
            Dapatkan jawaban instan dan terverifikasi yang diambil langsung dari
            RPS, Modul Praktikum, dan Jurnal Dosen.
          </p>

          <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
            <Link
              to="/register"
              className="w-full sm:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-xl text-sm transition shadow-md shadow-blue-200 flex items-center justify-center gap-2"
            >
              <span>Mulai Percakapan AI</span> 🚀
            </Link>
            <Link
              to="/login"
              className="w-full sm:w-auto text-center bg-white border border-slate-300 hover:bg-slate-100 text-slate-700 font-medium px-6 py-3 rounded-xl text-sm transition"
            >
              Buka Dashboard
            </Link>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="bg-slate-100 p-3 rounded-2xl rounded-tl-none text-xs text-slate-700 max-w-xs leading-relaxed">
                Halo! Ada yang bisa saya bantu terkait modul perkuliahan hari
                ini?
              </div>
            </div>
            ...
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-xl space-y-1">
              ...
              <p className="text-xs font-semibold text-slate-800">
                Modul 1 Praktikum Web Modern
              </p>
              <p className="text-[11px] text-slate-600 italic">
                "Tag semantik memberikan makna struktural seperti header, nav,
                main, dan footer..."
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
            <h2 className="text-2xl font-bold text-slate-900">
              Fitur Utama EduMate AI
            </h2>
            <p className="text-xs text-slate-500">
              Dirancang khusus untuk mendukung kegiatan akademis dan praktikum
              secara mandiri.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-xl bg-slate-50 border border-slate-200 space-y-3 hover:border-blue-300 transition">
              <div className="w-10 h-10 bg-blue-600 text-white rounded-lg flex items-center justify-center text-lg">
                💬
              </div>
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Menggunakan algoritma Retrieval-Augmented Generation untuk
                menyusun jawaban akurat berbasis konteks dokumen.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-50 border border-slate-200 space-y-3 hover:border-blue-300 transition">
              ...
              <h3 className="text-base font-bold text-slate-900">
                Sitasi Referensi Otomatis
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                Setiap jawaban dilengkapi indikator rujukan lengkap dengan nama
                modul, halaman, dan tingkat kemiripan vektor.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-50 border border-slate-200 space-y-3 hover:border-blue-300 transition">
              ...
              <h3 className="text-base font-bold text-slate-900">
                Portal Pengelolaan Dosen
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                Memudahkan dosen mengunggah berkas RPS, Modul, atau Jurnal
                terbaru untuk di-index ke Vector Database.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-4">
          <h2 className="text-2xl font-bold">
            Siap Memulai Perjalanan Belajar Lebih Efektif?
          </h2>
          <p className="text-xs text-slate-400 max-w-md mx-auto">
            Bergabunglah sekarang dan rasakan kemudahan belajar dengan
            pendamping AI yang terverifikasi.
          </p>
          <div className="pt-2">
            <Link
              to="/register"
              className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2.5 rounded-lg text-xs transition"
            >
              Buat Akun Mahasiswa
            </Link>
          </div>
